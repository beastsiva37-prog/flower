...
const ProductForm = ({ product, onClose, onSave }) => {
  ...
  useEffect(() => {
    if (product) {
      ...
      setCategory(product.category || 'Garland');
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex flex-col">
              <label className="text-xs font-semibold mb-1.5 text-darktext/60">Product Name*</label>
              <input 
                type="text" 
                value={productName} 
                ...
                placeholder="e.g. Traditional Red Rose Garland"
                required 
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col">
              <label className="text-xs font-semibold mb-3 text-darktext/60">Availability Status</label>
          ...
          <div className="flex flex-col">
            ...
            <textarea 
              ...
              placeholder="Describe flower type, size, scent, and puja suitability..."
              required 
            />
          </div>
          ...
          <div className="border border-dashed border-rosepink/30 bg-rosepink/5 p-6 rounded-2xl flex flex-col items-center justify-center text-center">
            ...
            <p className="font-bold text-maroon text-xs mb-1">Upload Product Images (Max 10)</p>
